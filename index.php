...
<body>
    <form id="vendorForm" onsubmit="sendData(event, 'vendorForm', 'vendor.php')">
    ...
    <form id="categoryForm" onsubmit="sendData(event, 'categoryForm', 'category.php')">
    ...
    <form id="priceForm" onsubmit="sendData(event, 'priceForm', 'price.php')">
        <h2>Price range</h2>
        <?php
